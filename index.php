...
<div class="container-fluid header-img">
				<div class="row">
					<div class="col-md-6 offset-md-3">
						...
						<div class="header">
							<h1 class="text-center"><i>Donate the blood, save the life</i></h1>
						<p class="text-center"><i><strong>Donate the blood to help the others.</strong></i></p>
						</div>
				...
				<div class="row">
					<div class="col-md-12">
						...
						<p class="text-center pera-text">
							<i><strong>The purpose to organize a blood donation camp is to motivate people to donate blood and social works. The purpose of blood donation camp to select a suitable donor whose blood will be safe to the recipient and who himself shall not in any way be harmed by blood donation.</strong></i>
						</p>
